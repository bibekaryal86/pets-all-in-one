...
import static pets.service.utils.Constants.ACCOUNT_TYPE_ID_CASH;
import static pets.service.utils.Constants.ACCOUNT_TYPE_ID_CHECKING;
import static pets.service.utils.Constants.ACCOUNT_TYPE_ID_CREDIT_CARD;
import static pets.service.utils.Constants.ACCOUNT_TYPE_ID_INVESTMENT;
import static pets.service.utils.Constants.ACCOUNT_TYPE_ID_LOANS_MORTGAGES;
import static pets.service.utils.Constants.ACCOUNT_TYPE_ID_OTHER_DEPOSITS;
import static pets.service.utils.Constants.ACCOUNT_TYPE_ID_OTHER_LOANS;
import static pets.service.utils.Constants.ACCOUNT_TYPE_ID_SAVINGS;
import static pets.service.utils.Constants.CATEGORY_ID_LOAN_PAYMENTS;
import static pets.service.utils.Constants.CATEGORY_ID_REFUNDS;
import static pets.service.utils.Constants.TRANSACTION_TYPE_ID_EXPENSE;
import static pets.service.utils.Constants.TRANSACTION_TYPE_ID_INCOME;
import static pets.service.utils.Constants.TRANSACTION_TYPE_ID_TRANSFER;
...
import pets.models.model.ReportCategories;
...
@Service
public class ReportsServiceSvc {

	private static final Logger logger = LoggerFactory.getLogger(ReportsServiceSvc.class);
    private final AccountServiceSvc accountService;
    private final TransactionServiceSvc transactionService;

    private static final String DATE_FORMAT = "%s-%s-%s";

    public ReportsServiceSvc(AccountServiceSvc accountService, TransactionServiceSvc transactionService) {
