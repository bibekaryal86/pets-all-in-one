...
import static pets.database.utils.Commons.convertDtoToEntityRefTransactionTypes;
...
import pets.database.repository.RefTransactionTypeRepository;
import pets.models.model.RefTransactionTypeRequest;
import pets.models.model.RefTransactionTypeResponse;
import pets.models.model.Status;

@Service
public class RefTransactionTypeServiceDb {
    private static final Logger logger = LoggerFactory.getLogger(RefTransactionTypeServiceDb.class);

    private final RefTransactionTypeRepository refTransactionTypeDao;

    public RefTransactionTypeServiceDb(RefTransactionTypeRepository refTransactionTypeDao) {
    ...
    public RefTransactionTypeResponse getAllRefTransactionTypes() {
        ...
        List<RefTransactionTypeDto> refTransactionTypes = new ArrayList<>();
        Status status = null;
        ...
        return RefTransactionTypeResponse.builder()
                .refTransactionTypes(convertDtoToEntityRefTransactionTypes(refTransactionTypes))
                .status(status)
                .build();
    }
    ...
    public RefTransactionTypeResponse getRefTransactionTypeById(String id) {
        ...
        RefTransactionTypeDto refTransactionType = null;
        Status status = null;
        ...
        return RefTransactionTypeResponse.builder()
                .refTransactionTypes(refTransactionType == null ? emptyList() : convertDtoToEntityRefTransactionTypes(singletonList(refTransactionType)))
                .status(status)
                .build();
    }
    ...
    public RefTransactionTypeResponse saveNewRefTransactionType(RefTransactionTypeRequest refTransactionTypeRequest) {
        ...
        RefTransactionTypeDto newRefTransactionType;
        Status status = null;

        try {
            newRefTransactionType = RefTransactionTypeDto.builder()
        ...
        return RefTransactionTypeResponse.builder()
                .refTransactionTypes(newRefTransactionType == null ? emptyList() : convertDtoToEntityRefTransactionTypes(singletonList(newRefTransactionType)))
                .status(status)
                .build();
    }
