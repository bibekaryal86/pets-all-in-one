...
import static pets.database.utils.Commons.convertDtoToEntityUsers;
...
import pets.database.repository.UserRepository;
import pets.models.model.Status;
import pets.models.model.UserRequest;
import pets.models.model.UserResponse;

@Service
public class UserServiceDb {
    private static final Logger logger = LoggerFactory.getLogger(UserServiceDb.class);
    ...
    public UserServiceDb(UserRepository userDao) {
    ...
    public UserResponse getAllUsers() {
        ...
        return UserResponse.builder()
                .users(convertDtoToEntityUsers(allUsers))
                .status(status)
                .build();
    }
    ...
    public UserResponse getUserById(String id) {
        ...
        return UserResponse.builder()
                .users(user == null ? emptyList() : convertDtoToEntityUsers(singletonList(user)))
                .status(status)
                .build();
    }
    ...
    public UserResponse saveNewUser(UserRequest userRequest) {
        ...
        return UserResponse.builder()
                .users(newUser == null ? emptyList() : convertDtoToEntityUsers(singletonList(newUser)))
                .status(status)
                .build();
    }
